 ...
 *
 * Interview Note:
 * These tests use Spring's MockMvc to simulate HTTP requests
 * without starting a full web server, making them fast and isolated.
 */
 ...
 * @AutoConfigureMockMvc provides MockMvc for testing controllers.
 */
@SpringBootTest
