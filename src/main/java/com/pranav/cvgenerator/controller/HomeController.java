 ...
 *
 * Interview Note:
 * This controller follows the MVC (Model-View-Controller) pattern.
 * It prepares data (Model), selects the template (View), and handles
 * requests (Controller). Thymeleaf renders the final HTML.
 */
 ...
 *
 * Interview Note:
 * @Controller (vs @RestController) indicates this returns view names,
 * not direct response bodies. Spring resolves view names to templates.
 */
@Controller
@Slf4j
public class HomeController {
     ...
     *
     * Interview Note:
     * The Model object is populated with data that Thymeleaf can access
     * using expressions like ${candidateName} in the template.
     *
