 ...
 *
 * Interview Note:
 * This controller provides a RESTful API following best practices:
 * - POST for creating resources (starting generation)
 * - GET for reading resources (status, results)
 ...
 * meaning all methods return data directly (not view names).
...
public class CvGenerationController {
     ...
     * Invalid requests will return 400 Bad Request automatically.
     *
