 ...
 *
 * Interview Note:
 * This controller demonstrates serving binary content from Spring.
 * Key concepts: Content-Disposition header for downloads, proper
 * MIME types, and ResponseEntity for complete response control.
 */
 ...
 *
 * Interview Note:
 * File downloads require careful handling of:
...
public class DownloadController {
     ...
     *
     * Interview Note:
     * Using "attachment" in Content-Disposition forces the browser to download
     * the file. Using "inline" would display it in the browser (if supported).
     *
     ...
     *
     * Interview Note:
     * LaTeX files are plain text, so we use UTF-8 encoding.
     * The MIME type application/x-tex is standard for .tex files.
     *
     * @param id The CV UUID
     ...
     *
     * Interview Note:
     * Most modern browsers can display PDFs inline. This is useful
     * for preview functionality before downloading.
     *
     * @param id The CV UUID
