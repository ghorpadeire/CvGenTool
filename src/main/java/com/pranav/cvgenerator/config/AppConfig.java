 ...
 *
 * Interview Note:
 * This class centralizes application-wide configuration that doesn't
 * fit into more specific config classes. It demonstrates the use of
 * @Bean methods for creating Spring-managed objects.
 */
 ...
 * allowing non-blocking CV generation.
 */
@Configuration
@EnableAsync
public class AppConfig {
     ...
     * Creating a single bean and reusing it is the recommended pattern.
     *
     ...
     *
     * Interview Note:
     * Thread pool sizing is important for resource management.
     * Too few threads = slow response times
     * Too many threads = memory exhaustion
     * The queue provides backpressure when the pool is saturated.
     *
