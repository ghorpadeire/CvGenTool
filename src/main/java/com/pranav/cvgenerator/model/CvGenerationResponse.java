 ...
 *
 * Interview Note:
 * This response DTO is designed for RESTful API consumption.
 * It includes HATEOAS-style links for related resources (PDF, TEX downloads).
 */
 ...
 * resulting in cleaner responses when optional fields are not set.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
